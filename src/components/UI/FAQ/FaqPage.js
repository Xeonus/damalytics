    ...
    <div className={classes.root}>
      <Grid item xs={12} container justify="center">
        ...
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography className={classes.heading} component={'div'}>What is the community calculator used for?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography component={'div'}>
            
            DAM and FLUX provide the first defaltionary dual token ecosystem on Ethereum giving unique incentives for participants.
            <br></br>
            <br></br>
            FLUX can only be generated by locking-in DAM tokens. FLUX is generated in a linear & predictable manner every 15 seconds. 
            FLUX mint ratio scales linearly based on the amount of FLUX destroyed from circulation. 
            <br></br>
            <br></br>
            The community calculator gives you a tool to identify how you can maximize your returns by locking-in DAM and burn FLUX to potentially
            get more FLUX.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading} component={'div'}>How is the DAM APR calculated? Why doesn't it change when I change my DAM amount?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography component={'div'}>
            ...
            The APR (annual percentage rate) then equates to the fraction of ROI in days vs 365 days. In the community calculator, APR is not calculated
            with compounding periods (that would be APY).
          </Typography>
        </AccordionDetails>
      </Accordion>
